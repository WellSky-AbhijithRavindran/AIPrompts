      ...
      **                                                                      **
      ** 08/07/2025  Alex Price ICON-1114                                     **
      **             - Change 992 to not print box 24J when minutes           **
      **               reimbursment type                                      **
      **                                                                      **
      ** 08/11/2025  SKosuri ICON-1116                                        **
      **             - Added BE 1006 to print Signature on File when Stepdown **
      **               by minutes exists on a charge                          **
      **                                                                      **
      ** 08/12/2025  Saikiran Parupalli  ICON-967                             **
      **             - Added Bill Exception 861 to print SNPI Supervisor Name **
      **               in Box 31 and NPI in 24J                               **
      **                                                                      **
      ** 08/13/2025   SKosuri ICON-971                                        **
      **             - Added BE 950 to print provider variable in Box 24J     **
      **               with G2 qualifier                                      **
      **                                                                      **
      **************************************************************************
      ...
      **********************************************************************
      /free
        begsr srsetupbox21;
         ...
         // with BE 992 and BE 1006, check if any procedure has
         // stepdown bu minutes reimbursement
         if (exc992 and (exc996 or exc1006));
           setll chgKey hbfchr15;
           dou %eof(hblchg15);
             reade chgKey hbfchr15;
             if not %eof(hblchg15);
               if bgReim = 'PRCRT' and exc996;
                 foundPrcrt = *on;
               endif;
               if (bgReim = 'SMINS' or bgReim = 'SMIND' or bgReim = 'SMINW')
                  and exc1006;
                 foundSmin = *on;
               endif;
               if exc996 = foundPrcrt and exc1006 = foundsmin;
                 leave;
               endif;
             endif;
           enddo;
